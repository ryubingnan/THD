...
{
    class PickupEntityTypeConfiguration : IEntityTypeConfiguration<Pickup>
    {
        public void Configure(EntityTypeBuilder<Pickup> b)
        {
            b.HasKey(e => e.Id);
            ...
            b.Property(e => e.Map).HasMaxLength(150);
